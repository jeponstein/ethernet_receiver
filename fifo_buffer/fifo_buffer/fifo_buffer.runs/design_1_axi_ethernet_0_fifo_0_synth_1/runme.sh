...
HD_PWD='C:/Users/20223108/Documents/github/ethernet_receiver/fifo_buffer/fifo_buffer/fifo_buffer.runs/design_1_axi_ethernet_0_fifo_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_ethernet_0_fifo_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_ethernet_0_fifo_0.tcl
